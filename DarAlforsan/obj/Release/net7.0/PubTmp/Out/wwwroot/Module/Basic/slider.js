            ...
            [
                ...
                },
                {
                    ...
                    render: function (data) {
                        let details = slider.extractContent(data);
                ...
                },
                {
                    data: "ID",
                    render: function (data) {
                        return `<a class="center-block" onclick="slider.initEdit(${data})"><i class="fas fa-pencil-alt text-primary"></i></a>`;
                    },
        ...
        try {
            $.ajax({
                ...
                success: function (data) {
                    $("#divSliderBody").html(data);
                    DragDrop.InitDropZone();
                    $("#AddSlider").bsModal("show");
