...
namespace DarAlforsan.Areas.Basic.Controllers
{
    [Authorize]
    [Area("Basic")]
    public class SchoolFruitsDetailsController : Core.UI.BaseController
    {
        public SchoolFruitsDetailsController(IConfiguration Config) : base(Config)
        {
        ...
        {
            var service = new Services.SchoolFruitsDetails();
            ...
            {
                plist.Data = plist.Data.OrderBy(x => x.GetType().GetProperty(colName).GetValue(x, null)).ToList<ViewModels.List.SchoolFruitsDetails>();
            }
            else //Order Descending
            {
                plist.Data = plist.Data.OrderByDescending(x => x.GetType().GetProperty(colName).GetValue(x, null)).ToList<ViewModels.List.SchoolFruitsDetails>();
            }
        ...
        {
            var service = new Services.SchoolFruitsDetails();
            return PartialView("_NewOrEdit", service.InitAdd());
        }
        //-----------------------------------------------------------------------------------------
        [HttpPost]
        public IActionResult Save(ViewModels.Form.SchoolFruitsDetails model)
        {
            try
            {
                var service = new Services.SchoolFruitsDetails();
        ...
        //-----------------------------------------------------------------------------------------
        public ActionResult GetByNewsID(long FruitsID)
        {
            var service = new Services.SchoolFruitsDetails();
            return PartialView("_SchoolFruitsDetailss", service.GetBySchoolFruitsID(FruitsID));
        }
        //-----------------------------------------------------------------------------------------
    }
}