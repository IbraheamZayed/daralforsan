            ...
            [
                ...
                },
                {
                    ...
                    render: function (data) {
                        let message = schoolSystem.extractContent(data);
                ...
                },
                {
                    data: "ID",
                    render: function (data) {
                        return `<a class="center-block" onclick="schoolSystem.initEdit(${data})"><i class="fas fa-pencil-alt text-primary"></i></a>`;
                    },
        ...
        try {
            $.ajax({
                ...
                success: function (data) {
                    $("#divSchoolSystemBody").html(data);
                    $("#AddSchoolSystem").bsModal("show");
